...
class Agent():
    ...
    def __init__(self, state_dim, action_dim, n_elements, h_dim = 200, epsilon = 0.9, LR_A = 1e-2, LR_C = 1e-2, gamma = 0.9, replace_iter = 10, memory_capacity = 20000, batch_size = 64, temperature=0.1):
