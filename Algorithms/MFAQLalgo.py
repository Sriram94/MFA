...
class MFAQL(nn.Module): 
    def __init__(self, state_dim, action_dim, n_elements, batch_size, hidden_dim=50, norm_in=False, attend_heads=4):
...
class Agent():
    ...
    def __init__(self, state_dim, action_dim, n_elements, h_dim = 50, epsilon = 0.9, LR_A = 0.01, LR_C = 0.01, gamma = 0.9, replace_iter = 10, memory_capacity = 20000, batch_size = 64, temperature=0.1):
