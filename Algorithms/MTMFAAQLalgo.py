...
class MTMFAAQL(nn.Module): 
    def __init__(self, state_dim, action_dim, action_dim2, n_elements, batch_size, observation_space, action_space, hidden_dim=50, norm_in=False, attend_heads=4):
...
class Agent():
    ...
    def __init__(self, state_dim, action_dim, action_dim2, n_elements, observation_space, action_space, h_dim = 50, epsilon = 0.9, LR_A = 1e-2, LR_C = 1e-2, gamma = 0.9, replace_iter = 10, memory_capacity = 20000, batch_size = 64, temperature=0.1):
