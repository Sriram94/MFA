...
class WMFRL(nn.Module): 
    def __init__(self, state_dim, action_dim, n_agents, batch_size, hidden_dim=50, norm_in=True, attend_heads=4):
...
class ActorNet(nn.Module):
    def __init__(self, state_dim, action_dim, h_dim = 50):
...
class Agent():
    ...
    def __init__(self, state_dim, action_dim, n_agents, h_dim = 50, epsilon = 0.9, LR_A = 1e-4, LR_C = 1e-2, gamma = 0.9, replace_iter_a = 10, replace_iter_c = 10, memory_capacity = 20000, batch_size = 64):
