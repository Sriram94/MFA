...
def run_battle(parallel_env):
    ...
    with open('pettingzoomagentmfaaql.csv', 'w+') as myfile:
        myfile.write('{0},{1},{2}\n'.format("Episode", "sumofrewards(MFAAQL)", "sumofrewards(MFAAQL)"))
    ...
    while num_episode < 5:
        ...
        with open('pettingzoomagentmfaaql.csv', 'a') as myfile:
