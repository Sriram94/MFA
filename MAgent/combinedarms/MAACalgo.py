...
class AttentionCritic(nn.Module): 
    def __init__(self, state_dim, action_dim, n_agents, batch_size, observation_space, action_space, hidden_dim=200, norm_in=True, attend_heads=4):
...
class Agent():
    ...
    def __init__(self, state_dim, action_dim, n_agents, observation_space, action_space, h_dim = 200, epsilon = 0.9, LR_A = 1e-4, LR_C = 1e-4, gamma = 0.9, replace_iter_a = 1100, replace_iter_c = 1000, memory_capacity = 20000, batch_size = 64):
        ...
        self.h_dim = h_dim
        self.eval_cnet, self.target_cnet = AttentionCritic(self.state_dim, self.action_dim, self.n_agents, batch_size,  observation_space, action_space, hidden_dim=self.h_dim).float(), AttentionCritic(self.state_dim, self.action_dim, self.n_agents, batch_size, observation_space, action_space, hidden_dim=self.h_dim).float()
