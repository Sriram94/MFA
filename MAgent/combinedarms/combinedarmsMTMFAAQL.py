...
import os
from MTMFAAQLalgo import Agent
import csv
import numpy as np 
...
def run_combinedarms(parallel_env):
    ...
    with open('pettingzoomagentmtmfaaql.csv', 'w+') as myfile:
        myfile.write('{0},{1},{2}\n'.format("Episode", "sumofrewards(MTFAAQL)", "sumofrewards(MTMFAAQL)"))
    ...
    while num_episode < 5:
        ...
        with open('pettingzoomagentmtmfaaql.csv', 'a') as myfile:
        ...
        agent1.save_param('./param/agent1mtmfaaql.pkl')
        agent2.save_param('./param/agent2mtmfaaql.pkl')
        agent3.save_param('./param/agent3mtmfaaql.pkl')
        agent4.save_param('./param/agent4mtmfaaql.pkl')
        
        agent1.load_param('./param/agent1mtmfaaql.pkl')
        agent2.load_param('./param/agent2mtmfaaql.pkl')
        agent3.load_param('./param/agent3mtmfaaql.pkl')
        agent4.load_param('./param/agent4mtmfaaql.pkl')
