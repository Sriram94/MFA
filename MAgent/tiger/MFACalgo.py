...
class Agent():
    ...
    def __init__(self, state_dim, action_dim, h_dim = 200, epsilon = 0.9, LR_A = 1e-4, LR_C = 1e-4, gamma = 0.9, replace_iter_a = 1100, replace_iter_c = 1000, memory_capacity = 20000, batch_size = 64, temperature=0.1):
