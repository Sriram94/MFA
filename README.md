...
Code base for the TMLR paper 7817: Revisiting Neighbourhoods in Mean Field Reinforcement Learning. 
...
Replace the files `battle_v4.py`, `gridworld.py`, `magent_env.py`, `tiger_deer_v4.py` in the installed MAgent library with the corresponding files in the MAgent folder of this repository. now, you are ready to start training. 
...
@article{SriramMFA2026,
  title = 	 {Revisiting Neighbourhoods in Mean Field Reinforcement Learning},
  author = 	 {Subramanian, Sriram Ganapathi and Taylor, Matthew E. and Larson, Kate and Crowley, Mark and Poupart, Pascal} 
  journal =  {Transactions on Machine Learning Research},
  year = 	 {2026},
  url = {https://openreview.net/forum?id=PQ5R7K0WDc&noteId=yoAoNIUbf9},
